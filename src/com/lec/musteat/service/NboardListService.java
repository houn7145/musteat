...
public class NboardListService implements Service {
	...
	public void execute(HttpServletRequest request, HttpServletResponse response) {
		...
		request.setAttribute("noitceBoardList", nDao.getNoticeBoardList(startRow, endRow));
		int totCnt = nDao.getNoticeBoardTotCnt();
